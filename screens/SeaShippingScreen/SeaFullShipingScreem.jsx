...
export default function SeaFullShipingScreem({navigation}) {
 ...
 <ScrollView        horizontal 
      showsHorizontalScrollIndicator={false} style={styles.TapsContainer} >
        ...
        {
              data.map((e, i) => (
                <CargoElement key={i} onPress={() => navigation.navigate("SeaFullShippingDetailsScreen", { orderId: e.id})} onPressIcon={() => navigation.navigate("EditRequestScreen", { orderId: e.id})}  data={e} />
              ))
            }
        </View>
        </View>
      ...
      <TitleTopBar title={"حاوية كاملة"}  navigation={navigation} />
