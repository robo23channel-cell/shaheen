...
import SeaCargoIcon from '../../../assets/SeaCargoIcon.svg'; 
    ...
    return (
        <TouchableOpacity onPress={onPress} style={styles.cardContainer}>
          ...
          <View style={styles.infoContainer}>
            ...
            <Text style={styles.title}>{data?.country?.countryCode}-{data?.orderNumber}-LC</Text>
...
const styles = StyleSheet.create({
    ...
    statusText: {
      backgroundColor: '#28A745', // Green background for status text
      color: 'white',
      borderRadius: 10,
      padding: 5,
